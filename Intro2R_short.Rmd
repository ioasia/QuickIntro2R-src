...
## Note that we selectively pretend that our home directory is really z:/OmicsDataAnalysis
## This needs care whne runnnig from other places
...
Both R and RStudio are open source software, and freely available online^[Installers can be run with defaults.], but where R is community-developed and non-profit^[[www.r-project.org/foundation/](https://www.r-project.org/foundation/)], RStudio is the product of a commercial entity^[[https://www.rstudio.com/about/](https://www.rstudio.com/about/)].
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/05_RStudio_1_3_1093_Windows10_EnvTab_structure.png}\caption{RStudio Environment tab also showing the structure of ex1}
\end{marginfigure}
