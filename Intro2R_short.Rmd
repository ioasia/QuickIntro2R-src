...
The latest version of this document, as well as the accompanying data files and example scripts, is available from Github.^[[github.com/alexploner/QuickIntro2R](https://github.com/alexploner/QuickIntro2R)]
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/00_Rproject_4_0_3.png}\caption{R homepage \url{https://www.r-project.org/}}
\end{marginfigure}
...
The RStudio program window is typically split into up to four different quadrants or _panes_. Figure 1 shows a typical configuration: 

\begin{figure*}
\centering 
\includegraphics[width=\textwidth]{figures/01_RStudio_1_3_1093_Windows10.png}\caption{RStudio running R 4.0.3}
\end{figure*}
...
* The smaller top right pane shows the **Environment** tab, which displays all currently defined objects (like data sets or analysis results) in a the current R session. Figure 1 shows RStudio at the start of a session, so objects are defined yet, and the environment is empty.
...
Note that the two smaller panes are _tabbed_, i.e. other functionality is available in separate tabs (like _History_ on the top and _Packages_ and _Plots_ on the bottom). This will be discussed in detail below.
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/02_RStudio_1_3_1093_Windows10_Help_ttest.png}\caption{RStudio Help tab}
\end{marginfigure}
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/03_RStudio_1_3_1093_Windows10_EnvTab_list.png}\caption{RStudio Environment tab}
\end{marginfigure}
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/04_RStudio_1_3_1093_Windows10_EnvTab_import.png}\caption{RStudio Environment with import menu}
\end{marginfigure}
...
We use `read.table` to import the data file, which we directly save as object `ex1`. The argument `header=TRUE` tells `read.table` to use the first row as column names, and the argument `stringsAsFactors = TRUE` to import the character coumn directly as a factor variable:
```{r, eval=1, R.options = list(width = 60)}
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/05_RStudio_1_3_1093_Windows10_EnvTab_structure.png}\caption{RStudio Environment tab also showing structure of ex1}
\end{marginfigure}
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/06_RStudio_1_3_1093_Windows10_FilesTab.png}\caption{RStudio Files pane}
\end{marginfigure}
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/07_RStudio_1_3_1093_Windows10_PlotTab_Export.png}\caption{RStudio Files pane}
\end{marginfigure}
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/08_RStudio_1_3_1093_Windows10_Quit.png}\caption{R Quit dialogue}
\end{marginfigure}
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/10_CRAN_4_0_3.png}\caption{CRAN \url{https://cran.r-project.org/}}
\end{marginfigure}
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/11_Bioconductor_3_12.png}\caption{Bioconductor \url{https://www.bioconductor.org/}}
\end{marginfigure}
...
2. The package needs to be _loaded_: this tells R to activate the installed copy of the package and make its built-in commands and data sets available at the console. This is done via the command `library`, as in 
    ...
    Note that loading is required _once per session_, namely the first time before you use one of the package commands or data sets; after the package has been loaded as above, it syats activated until the end of the R session. 
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/09_RStudio_1_3_1093_Windows10_PackagesTab.png}\caption{RStudio Package pane}
\end{marginfigure}

\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/12_RStudio_1_3_1093_Windows10_PackagesTab_Install.png}\caption{RStudio Package pane with Install dialogue}
\end{marginfigure}
...
* For CRAN, these are _task views_^[[cran.r-project.org/web/views/](https://cran.r-project.org/web/views/)]: e.g. for genetic applications^[[cran.r-project.org/web/views/Genetics.html](https://cran.r-project.org/web/views/Genetics.html)]
...
\begin{marginfigure}
\centering 
\includegraphics[width=\textwidth]{figures/13_RStudio_1_3_1093_Windows10_HistoryTab.png}\caption{RStudio History pane showing the workflow example}
\end{marginfigure}
...
\begin{figure*}
\centering 
\includegraphics[width=\textwidth]{figures/14_RStudio_1_3_1093_Windows10_wSourcePane.png}\caption{RStudio with open Source pane showing script script1.R\label{fig:Source}}
\end{figure*}
...
Comments are easy to add: R/RStudio will ignore any text after a hastag `#` until the end of the current line.
...
* RStudio cheatsheets: 1-page summaries on how to use RStudio, specific packages, or perform specific packages^[[rstudio.com/resources/cheatsheets/](https://rstudio.com/resources/cheatsheets/)]
